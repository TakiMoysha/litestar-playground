    ...
    cert = (
        ...
        .add_extension(
            x509.SubjectAlternativeName(
                ...
                + [x509.DNSName(addr) for addr in ip_addresses if ip_addresses]
                if ip_addresses
...
type THostname = str
type TIPAddr = str  # IPv4Address | IPv6Address


def main(hostname: str, ip_addresses: list[TIPAddr], output_dir: str):
